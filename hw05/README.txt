Cross Compiling:
1.the output of the "Hello World" program from the host
Hello, World! Main is executing at 0x400596
This address (0x7ffcbe805400) is in our stack frame
This address (0x601048) is in our bss section
This address (0x601040) is in our data section

2.the output of the "Hello World" program from the Bone
Hello, World! Main is executing at 0x103d5
This address (0xbeadabd4) is in our stack frame
