...
function command(){
   ...
   if(count%4 == 1){
    ...
    if(mode == 1&&count == min_index){
        ...
        console.log('enter real-time tracking mode');
        realtrack();
    }
}    
...
function ana0callback1(x){
    ana0read = x.value;
    console.log('ana0read='+ana0read);
}

function ana1callback1(x){
    ana1read = x.value;
    console.log('ana1read='+ana1read);
}
...
function track(){
      b.analogRead('P9_39',ana0callback1);
      b.analogRead('P9_40',ana1callback1);
